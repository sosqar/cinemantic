...
//        for (Film film : films) {
//            System.out.printf("%-40s | %-5s%n",
//                    film.getTitle(), film.getRating());
//        }
//        printer.printSeparator(10);
//    }
//
...
//        System.out.printf("%-5s | %-40s | %-5s%n", "Title", "Votes");
//        printer.printSeparator(10);
//
//        for (Film film : films) {
//            System.out.printf("%-5s | %-40s | %-5s%n", film.getTitle(), film.getVotes());
//        }
//        printer.printSeparator(10);
//
//    }
...
//                System.out.printf("%-40s | %-15s | %-5s | %-5s%n",
